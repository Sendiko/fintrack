...
class TransactionDataSourceImpl(
    ...
    override suspend fun getTransaction(id: String): Result<GetTransactionResponse, DataError.Remote> {
        return safeCall<GetTransactionResponse> {
    ...
    ): Result<PutTransactionResponse, DataError.Remote> {
        return safeCall<PutTransactionResponse> {
